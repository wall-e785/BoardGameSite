...
<div class="body">
        ...
        <form class="search-form" action="search.php">
            <div class="search-form-container">
                <div class="search-column">
                    ...
                    <input class="labelAbove" type="text" id="gameName" name="gameName" <?php if (!empty($GameName))
                        echo "value=" . $GameName; ?>>

                    <label class="labelAbove label-size-p" for="gameYear">Year</label>
                    <input class="labelAbove" type="text" id="gameYear" name="gameYear" <?php if (!empty($GameYear))
                        echo "value=" . $GameYear; ?>>

                    <label class="labelAbove label-size-p" for="gameDesigner">Designer</label>
                    <input class="labelAbove" type="text" id="gameDesigner" name="gameDesigner" <?php if (!empty($GameDesigner))
                        echo "value=" . $GameDesigner; ?>>
                </div>
                <div class="search-column">
                    ...
                    <div class="search-form-numfield">
                        ...
                        <input type="text" id="playersMin" name="playersMin" <?php if (!empty($PlayersMin))
                            echo "value=" . $PlayersMin; ?>>
                        <label for="playersMax"> max: </label>
                        <input type="text" id="playersMax" name="playersMax" <?php if (!empty($PlayersMax))
                            echo "value=" . $PlayersMax; ?>>
                    </div>

                    <p>Time</p>
                    <div class="search-form-numfield">
                        <label for="timeMin">min: </label>
                        <input type="text" id="timeMin" name="timeMin" <?php if (!empty($TimeMin))
                            echo "value=" . $TimeMin; ?>>
                        <label for="timeMax"> max: </label>
                        <input type="text" id="timeMax" name="timeMax" <?php if (!empty($TimeMax))
                            echo "value=" . $TimeMax; ?>>
                    </div>
                    ...
                    <div class="search-form-numfield">
                        ...
                        <input type="text" id="ratingMin" name="ratingMin" <?php if (!empty($RatingMin))
                            echo "value=" . $RatingMin; ?>>
                        <label for="ratingMax"> max: </label>
                        <input type="text" id="ratingMax" name="ratingMax" <?php if (!empty($RatingMax))
                            echo "value=" . $RatingMax; ?>>
                    </div>
                </div>
                <div class="search-column">
                    <p>Categories</p>
    ...
    while ($row = $res2->fetch_assoc()) {
        ...
        $boardgamepage = url_for('viewboardgame.php');
